...
describe('Pruebas en 08-imp-exp.test.js', () => {
    ...
    test('getHeroeById debe retornar undefined si no existe el ID', () => {
        ...
        expect(hero).toBeFalsy(); // Para valores undefined, null, 0, '' o false
    });
    ...
    test('getHeroesByOwner debe retornar un arreglo con los héroes de DC', () => {
        ...
        expect(heroes).toEqual(heroes.filter((heroe) => heroe.owner === owner)); // Para que la prueba sea más flexible
    });
